...
class Base(DeclarativeBase):
    ...
    engine = create_engine('postgresql://dev:F6r58h7G2e@127.0.0.1:5432/clean_blog')
    session = sessionmaker(bind=engine)

    async_engine = create_async_engine('postgresql+asyncpg://dev:F6r58h7G2e@127.0.0.1:5432/clean_blog')
